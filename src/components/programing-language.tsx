...
export default function ProgramingLanguage() {
    const items = [
        ...
        <SiNextdotjs key="next" size={50} className="text-main" />,
        ...
        <SiExpress key="express" size={50} className="text-main" />,
        <SiPostgresql key="pg" size={50} fill="#9D90FF" />,
        ...
        <SiGithub key="github" size={50} className="text-main" />,
        <SiVercel key="vercel" size={50} className="text-main" />,
